...
class JudgesControllerTest < ActionController::TestCase
  ...
  test "should create judge" do
    assert_difference('Judge.count') do
      post :create, judge: { guess_id: @judge.guess_id, judge: @judge.judge, time: @judge.time, user_id: @judge.user_id }
    end
  ...
  test "should update judge" do
    patch :update, id: @judge, judge: { guess_id: @judge.guess_id, judge: @judge.judge, time: @judge.time, user_id: @judge.user_id }
    assert_redirected_to judge_path(assigns(:judge))
  end
